...
//import entites.JFilePicker;


import ttma.client.technique.*;
...
public class EnvoiMail extends JFrame {
	...
	private JLabel labelTo = new JLabel("A : ");
	private JLabel labelSubject = new JLabel("OBJET: ");
	...
	//private f
	private JFileChooser fileChooser = new JFileChooser("Attached");
	...
	private void setupMenu() {
		menuItemSetting.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				SettingsDialog dialog = new SettingsDialog(EnvoiMail.this, configUtil);
	...
	private boolean validateFields() {
		if (fieldTo.getText().equals("")) {
			JOptionPane.showMessageDialog(this, 
					"entrez l'adresse  destinataire svp!",
					"Error", JOptionPane.ERROR_MESSAGE);
